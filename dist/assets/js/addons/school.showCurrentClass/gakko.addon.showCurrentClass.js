    ...
    constructor(eIcon, cName, bTime) {
        ...
        function update() {
            switch (true) {
                ...
                case (currentHourMinutes < '0925'):
                    // c2
                    classStateIcon.innerHTML = '<i class="material-icons">school</i>';
                    classStateName.innerHTML = '2. hodina';
                    break;
                case (currentHourMinutes < '0935'):
                    // c2 - b10 => c3
                    classStateIcon.innerHTML = '<i class="material-icons">fastfood</i>';
                    classStateName.innerHTML = '10-minútová prestávka';
                    break;
                case (currentHourMinutes < '1020'):
                    // c3
                    classStateIcon.innerHTML = '<i class="material-icons">school</i>';
                    classStateName.innerHTML = '3. hodina';
                    break;
                ...
                case (currentHourMinutes < '1115'):
                    // c4
                    classStateIcon.innerHTML = '<i class="material-icons">school</i>';
                    classStateName.innerHTML = '4. hodina';
                    break;
                ...
                case (currentHourMinutes < '1415'):
                    // c7
                    classStateIcon.innerHTML = '<i class="material-icons">school</i>';
                    classStateName.innerHTML = '7. hodina';
                    break;
                ...
                case (currentHourMinutes < '1505'):
                    // c8
                    classStateIcon.innerHTML = '<i class="material-icons">school</i>';
                    classStateName.innerHTML = '8. hodina';
                    break;
                default:
                    // EOC
                    classStateIcon.innerHTML = '<i class="material-icons">done_all</i>';
                    classStateName.innerHTML = 'Koniec vyučovania';
                    classStateTime.innerHTML = '\\ (•◡•) /';
                    break;
            };
        }
        ...
        function showTime() {
            switch (true) {
                case (currentHourMinutes < '0700'):
                    // c_null
                    classStateTime.innerHTML = 'Vyučovanie začína o 7:00';
                    break;
                case (currentHourMinutes < '0745'):
                    // c0
                    classStateTime.innerHTML = 'Koniec 07:45';
                    break;
                case (currentHourMinutes < '0750'):
                    // c0 - b5 => c1
                    classStateTime.innerHTML = 'Koniec 07:50';
                    break;
                case (currentHourMinutes < '0835'):
                    // c1
                    classStateTime.innerHTML = 'Koniec 08:35';
                    break;
                case (currentHourMinutes < '0840'):
                    // c1 - b5 => c2
                    classStateTime.innerHTML = 'Koniec 08:40';
                    break;
                case (currentHourMinutes < '0925'):
                    // c2
                    classStateTime.innerHTML = 'Koniec 09:25';
                    break;
                case (currentHourMinutes < '0935'):
                    // c2 - b10 => c3
                    classStateTime.innerHTML = 'Koniec 09:35';
                    break;
                case (currentHourMinutes < '1020'):
                    // c3
                    classStateTime.innerHTML = 'Koniec 10:20';
                    break;
                case (currentHourMinutes < '1030'):
                    // c3 - b10 => c4
                    classStateTime.innerHTML = 'Koniec 10:30';
                    break;
                case (currentHourMinutes < '1115'):
                    // c4
                    classStateTime.innerHTML = 'Koniec 11:15';
                    break;
                case (currentHourMinutes < '1120'):
                    // c4 - b5 => c5
                    classStateTime.innerHTML = 'Koniec 11:20';
                    break;
                case (currentHourMinutes < '1205'):
                    // c5
                    classStateTime.innerHTML = 'Koniec 12:05';
                    break;
                case (currentHourMinutes < '1240'):
                    // c5 - b30 => c6
                    classStateTime.innerHTML = 'Koniec 12:40';
                    break;
                case (currentHourMinutes < '1325'):
                    // c6
                    classStateTime.innerHTML = 'Koniec 13:25';
                    break;
                case (currentHourMinutes < '1330'):
                    // c6 - b5 => c7
                    classStateTime.innerHTML = 'Koniec 13:30';
                    break;
                case (currentHourMinutes < '1415'):
                    // c7
                    classStateTime.innerHTML = 'Koniec 14:15';
                    break;
                case (currentHourMinutes < '1420'):
                    // c7 - b5 => c8
                    classStateTime.innerHTML = 'Koniec ';
                    break;
                case (currentHourMinutes < '1505'):
                    // c8
